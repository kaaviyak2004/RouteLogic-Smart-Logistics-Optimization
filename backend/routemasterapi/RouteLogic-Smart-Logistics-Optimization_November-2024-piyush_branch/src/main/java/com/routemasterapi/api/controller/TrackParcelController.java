...
public class TrackParcelController {
	...
	@RequestMapping(value = "/trackParcelsCount", method = RequestMethod.GET)
	public ResponseEntity<?> countNumberOfTrackParcels() throws Exception {
		return ResponseEntity.ok((trackParcelService.countNumberOfTrackParcels()));
	}
}