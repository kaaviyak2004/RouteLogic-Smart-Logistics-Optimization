...
public class RouteController {
	...
	public ResponseEntity<?> deleteRoute(@RequestBody RouteIdRequest routeIdRequest) throws Exception {
		return ResponseEntity.ok(routeService.deleteUser(routeIdRequest));
	}
	
	@RequestMapping(value = "/routesCount", method = RequestMethod.GET)
	public ResponseEntity<?> countNumberOfRoutes() throws Exception {
		return ResponseEntity.ok(routeService.countNumberofRoutes());
	}
